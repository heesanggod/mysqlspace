...
DELETE FROM example_table WHERE int_column = 50;  -- int 컬럼에 50인 것들 다 삭제
DELETE FROM example_table; -- 전부 삭제 (데이터만 삭제)

TRUNCATE TABLE example_table;   -- 구조만 남기고 모두 삭제 (초기화)
